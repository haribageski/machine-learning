...
class SentimentAnalyzerTest  extends FlatSpec with Matchers {
  "evaluateSentiOfAllCompanyNews()" should
    ...
    val news1 = News(symbol, DateExtended("18/06/2013"), 2013,
    ...
    val news2 = News(symbol, DateExtended("18/06/2013"), 2013,
    ...
    CompanyNewsSentiment(
      symbol,
      Map(DateExtended("18/06/2013") -> sentimentAvgTitle1, DateExtended("02/03/2014") -> sentimentAvgTitle2),
      Map(DateExtended("18/06/2013") -> sentimentAvgDescript1, DateExtended("02/03/2014") -> sentimentAvgDescript2)
